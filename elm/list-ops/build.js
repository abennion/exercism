...
var _exercism$xelm$ListOps$concat = function (a) {
	var _p0 = a;
	if (_p0.ctor === '[]') {
		return _elm_lang$core$Native_List.fromArray(
			[]);
		...
		return A2(
			_elm_lang$core$Basics_ops['++'],
			_p0._0,
			_exercism$xelm$ListOps$concat(_p0._1));
	}
};
var _exercism$xelm$ListOps$append = F2(
	function (a, b) {
		return A2(_elm_lang$core$Basics_ops['++'], a, b);
	});
var _exercism$xelm$ListOps$foldl = F3(
	function (fn, r, a) {
		foldl:
		while (true) {
			var _p1 = a;
...
var _exercism$xelm$ListOps$filter = F2(
	function (fn, a) {
		filter:
		while (true) {
			var _p2 = a;
			if (_p2.ctor === '[]') {
				...
				if (_elm_lang$core$Native_Utils.eq(
					...
					return A2(
						_elm_lang$core$List_ops['::'],
						_p3,
						A2(_exercism$xelm$ListOps$filter, fn, _p4));
				} else {
					var _v6 = fn,
						_v7 = _p4;
					fn = _v6;
...
var _exercism$xelm$ListOps$map = F2(
	function (fn, a) {
		var _p5 = a;
		if (_p5.ctor === '[]') {
			return _elm_lang$core$Native_List.fromArray(
			...
			return A2(
				_elm_lang$core$List_ops['::'],
				fn(_p5._0),
				A2(_exercism$xelm$ListOps$map, fn, _p5._1));
		}
	});
var _exercism$xelm$ListOps$reverse = function (a) {
	var _p6 = a;
	if (_p6.ctor === '[]') {
		return _elm_lang$core$Native_List.fromArray(
			[]);
		...
		return A2(
			_elm_lang$core$Basics_ops['++'],
			_exercism$xelm$ListOps$reverse(_p6._1),
			_elm_lang$core$Native_List.fromArray(
				[_p6._0]));
	}
};
var _exercism$xelm$ListOps$foldr = F3(
	function (fn, r, a) {
		return A3(
			_exercism$xelm$ListOps$foldl,
			fn,
			r,
			_exercism$xelm$ListOps$reverse(a));
	});
var _exercism$xelm$ListOps$length = function (a) {
	var _p7 = a;
	if (_p7.ctor === '[]') {
		return 0;
	} else {
		return _exercism$xelm$ListOps$length(_p7._1) + 1;
	}
};
		...
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[]),
						_exercism$xelm$ListOps$reverse(
							_elm_lang$core$Native_List.fromArray(
								[])))),
					A2(
					_elm_community$elm_test$ElmTest$test,
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					A2(
						_elm_community$elm_test$ElmTest$assertEqual,
						_elm_lang$core$Native_List.range(2, 5),
						A2(
							_exercism$xelm$ListOps$map,
							F2(
								function (x, y) {
				...
				[
					...
					A2(
						...
						A2(
							_exercism$xelm$ListOps$append,
							_elm_lang$core$Native_List.range(1, 4),
							_elm_lang$core$Native_List.range(5, 8))))
				])),
			A2(
			_elm_community$elm_test$ElmTest$suite,
			'concat',
						...
						_exercism$xelm$ListOps$concat(
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_elm_lang$core$Native_List.fromArray(
									[]),
									_elm_lang$core$Native_List.range(4, 7),
									_elm_lang$core$Native_List.range(8, 10)
								]))))
				]))
		]));

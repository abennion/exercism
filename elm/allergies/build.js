...
var _exercism$xelm$Allergies$allergies = _elm_lang$core$Dict$fromList(
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'eggs', _1: 1},
			{ctor: '_Tuple2', _0: 'peanuts', _1: 2},
			{ctor: '_Tuple2', _0: 'shellfish', _1: 4},
			{ctor: '_Tuple2', _0: 'strawberries', _1: 8},
			{ctor: '_Tuple2', _0: 'tomatoes', _1: 16},
			{ctor: '_Tuple2', _0: 'chocolate', _1: 32},
			{ctor: '_Tuple2', _0: 'pollen', _1: 64},
			{ctor: '_Tuple2', _0: 'cats', _1: 128}
		]));
var _exercism$xelm$Allergies$isAllergicTo = F2(
		...
		return !_elm_lang$core$Native_Utils.eq(
			A2(
				...
				A2(
					...
					0,
					A2(_elm_lang$core$Dict$get, allergy, _exercism$xelm$Allergies$allergies)),
				score),
			0);
	});
var _exercism$xelm$Allergies$toList = function (score) {
	return A2(
		_elm_lang$core$List$filter,
		function (k) {
			return A2(_exercism$xelm$Allergies$isAllergicTo, k, score);
		},
		_elm_lang$core$Dict$keys(_exercism$xelm$Allergies$allergies));
};
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							'peanuts',
							_elm_community$elm_test$ElmTest$assert(
								_elm_lang$core$Basics$not(
									A2(_exercism$xelm$Allergies$isAllergicTo, 'peanuts', 0)))),
							A2(
							_elm_community$elm_test$ElmTest$test,
							'cats',
							_elm_community$elm_test$ElmTest$assert(
								_elm_lang$core$Basics$not(
									A2(_exercism$xelm$Allergies$isAllergicTo, 'cats', 0)))),
							A2(
							_elm_community$elm_test$ElmTest$test,
							'strawberries',
							_elm_community$elm_test$ElmTest$assert(
								_elm_lang$core$Basics$not(
									A2(_exercism$xelm$Allergies$isAllergicTo, 'strawberries', 0))))
						])),
					A2(
					_elm_community$elm_test$ElmTest$test,
					'is allergic to eggs',
					_elm_community$elm_test$ElmTest$assert(
						A2(_exercism$xelm$Allergies$isAllergicTo, 'eggs', 1))),
					A2(
					_elm_community$elm_test$ElmTest$suite,
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							'eggs',
							_elm_community$elm_test$ElmTest$assert(
								A2(_exercism$xelm$Allergies$isAllergicTo, 'eggs', 5))),
							A2(
							_elm_community$elm_test$ElmTest$test,
							'shellfish',
							_elm_community$elm_test$ElmTest$assert(
								A2(_exercism$xelm$Allergies$isAllergicTo, 'shellfish', 5))),
							A2(
							_elm_community$elm_test$ElmTest$test,
							'strawberries',
							_elm_community$elm_test$ElmTest$assert(
								_elm_lang$core$Basics$not(
									A2(_exercism$xelm$Allergies$isAllergicTo, 'strawberries', 5))))
						]))
				])),
			A2(
			_elm_community$elm_test$ElmTest$suite,
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[]),
						_exercism$xelm$Allergies$toList(0))),
					A2(
					_elm_community$elm_test$ElmTest$test,
					...
					A2(
						...
						_elm_lang$core$Native_List.fromArray(
							['peanuts']),
						_exercism$xelm$Allergies$toList(2))),
					A2(
					_elm_community$elm_test$ElmTest$test,
					...
					A2(
						...
						_elm_lang$core$List$sort(
							_exercism$xelm$Allergies$toList(255)))),
					A2(
					_elm_community$elm_test$ElmTest$test,
					...
					A2(
						...
						_elm_lang$core$Native_List.fromArray(
							['eggs']),
						_exercism$xelm$Allergies$toList(257))),
					A2(
					_elm_community$elm_test$ElmTest$test,
					'ignore non allergen score parts',
					A2(
						...
						_elm_lang$core$List$sort(
							_exercism$xelm$Allergies$toList(509))))
				]))
		]));

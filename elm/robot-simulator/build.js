...
var _exercism$xelm$RobotSimulator$advance = function (robot) {
	var _p0 = function (_) {
		return _.bearing;
	}(robot);
	switch (_p0.ctor) {
		case 'North':
			return _elm_lang$core$Native_Utils.update(
				robot,
				{
					coordinates: {x: robot.coordinates.x, y: robot.coordinates.y + 1}
				});
		case 'East':
			return _elm_lang$core$Native_Utils.update(
				robot,
				{
					coordinates: {x: robot.coordinates.x + 1, y: robot.coordinates.y}
				});
		case 'South':
			return _elm_lang$core$Native_Utils.update(
				robot,
...
var _exercism$xelm$RobotSimulator$bearing = function (robot) {
	return function (_) {
		return _.bearing;
	}(robot);
};
var _exercism$xelm$RobotSimulator$Coordinates = F2(
	function (a, b) {
		return {x: a, y: b};
	});
var _exercism$xelm$RobotSimulator$Robot = F2(
	function (a, b) {
		return {bearing: a, coordinates: b};
	});
var _exercism$xelm$RobotSimulator$West = {ctor: 'West'};
var _exercism$xelm$RobotSimulator$South = {ctor: 'South'};
var _exercism$xelm$RobotSimulator$East = {ctor: 'East'};
var _exercism$xelm$RobotSimulator$North = {ctor: 'North'};
var _exercism$xelm$RobotSimulator$defaultRobot = {
	bearing: _exercism$xelm$RobotSimulator$North,
	coordinates: {x: 0, y: 0}
};
var _exercism$xelm$RobotSimulator$turnRight = function (robot) {
	var _p1 = function (_) {
		return _.bearing;
	}(robot);
	switch (_p1.ctor) {
		case 'North':
			return _elm_lang$core$Native_Utils.update(
				robot,
				{bearing: _exercism$xelm$RobotSimulator$East});
		case 'East':
			return _elm_lang$core$Native_Utils.update(
				robot,
				{bearing: _exercism$xelm$RobotSimulator$South});
		case 'South':
			return _elm_lang$core$Native_Utils.update(
				robot,
				{bearing: _exercism$xelm$RobotSimulator$West});
		default:
			return _elm_lang$core$Native_Utils.update(
				robot,
				{bearing: _exercism$xelm$RobotSimulator$North});
...
var _exercism$xelm$RobotSimulator$turnLeft = function (robot) {
	var _p2 = function (_) {
		return _.bearing;
	}(robot);
	switch (_p2.ctor) {
...
var _exercism$xelm$RobotSimulator$instruct = F2(
	function (instruction, robot) {
		var _p3 = instruction;
		switch (_p3.valueOf()) {
			case 'L':
				return _exercism$xelm$RobotSimulator$turnLeft(robot);
			case 'R':
				return _exercism$xelm$RobotSimulator$turnRight(robot);
			case 'A':
				return _exercism$xelm$RobotSimulator$advance(robot);
			default:
				return robot;
		}
	});
var _exercism$xelm$RobotSimulator$simulate = F2(
	function (instructions, robot) {
		return A3(
			_elm_lang$core$List$foldl,
			_exercism$xelm$RobotSimulator$instruct,
			robot,
			_elm_lang$core$String$toList(instructions));
	});
...
var _exercism$xelm$Main$tests = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			...
			'init',
			function () {
				var robot = _exercism$xelm$RobotSimulator$defaultRobot;
				return _elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_community$elm_test$ElmTest$test,
						'bearing',
						A2(_elm_community$elm_test$ElmTest$assertEqual, _exercism$xelm$RobotSimulator$North, robot.bearing))
					]);
			}()),
			A2(
			_elm_community$elm_test$ElmTest$suite,
			...
			function () {
				var robot = A2(
					_exercism$xelm$RobotSimulator$Robot,
					_exercism$xelm$RobotSimulator$South,
					{x: -1, y: 1});
				return _elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_community$elm_test$ElmTest$test,
						'bearing',
						A2(_elm_community$elm_test$ElmTest$assertEqual, _exercism$xelm$RobotSimulator$South, robot.bearing))
					]);
			}()),
			A2(
			_elm_community$elm_test$ElmTest$suite,
			...
			A2(
				_elm_lang$core$List$map,
				_elm_community$elm_test$ElmTest$defaultTest,
				A2(
					_elm_community$elm_test$ElmTest$assertionList,
					_elm_lang$core$Native_List.fromArray(
						[_exercism$xelm$RobotSimulator$North, _exercism$xelm$RobotSimulator$East, _exercism$xelm$RobotSimulator$South, _exercism$xelm$RobotSimulator$West]),
					A2(
						_elm_lang$core$List$map,
						function (_) {
							return _.bearing;
						...
						A3(
							...
							F2(
								function (_p0, r) {
									return _exercism$xelm$RobotSimulator$turnRight(r);
								}),
							_exercism$xelm$RobotSimulator$defaultRobot,
			...
			A2(
				...
				A2(
					_elm_community$elm_test$ElmTest$assertionList,
					_elm_lang$core$Native_List.fromArray(
						[_exercism$xelm$RobotSimulator$North, _exercism$xelm$RobotSimulator$West, _exercism$xelm$RobotSimulator$South, _exercism$xelm$RobotSimulator$East]),
					A2(
						_elm_lang$core$List$map,
						function (_) {
							return _.bearing;
						...
						A3(
							...
							F2(
								function (_p1, r) {
									return _exercism$xelm$RobotSimulator$turnLeft(r);
								}),
							_exercism$xelm$RobotSimulator$defaultRobot,
							_elm_lang$core$Native_List.range(1, 3)))))),
			A2(
			...
			function () {
				var robot = _exercism$xelm$RobotSimulator$advance(
					A2(
						_exercism$xelm$RobotSimulator$Robot,
						_exercism$xelm$RobotSimulator$North,
						{x: 0, y: 0}));
				return _elm_lang$core$Native_List.fromArray(
					[
						A2(
			...
			function () {
				var robot = _exercism$xelm$RobotSimulator$advance(
					A2(
						_exercism$xelm$RobotSimulator$Robot,
						_exercism$xelm$RobotSimulator$East,
						{x: 0, y: 0}));
				return _elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_community$elm_test$ElmTest$test,
						'bearing',
						A2(_elm_community$elm_test$ElmTest$assertEqual, _exercism$xelm$RobotSimulator$East, robot.bearing))
					]);
			}()),
			A2(
			_elm_community$elm_test$ElmTest$suite,
			...
			function () {
				var robot = _exercism$xelm$RobotSimulator$advance(
					A2(
						_exercism$xelm$RobotSimulator$Robot,
						_exercism$xelm$RobotSimulator$West,
						{x: 0, y: 0}));
				return _elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_community$elm_test$ElmTest$test,
						'bearing',
						A2(_elm_community$elm_test$ElmTest$assertEqual, _exercism$xelm$RobotSimulator$West, robot.bearing))
					]);
			}()),
			A2(
			_elm_community$elm_test$ElmTest$suite,
			...
			function () {
				var robot = A2(
					_exercism$xelm$RobotSimulator$simulate,
					'LAAARALA',
					A2(
						_exercism$xelm$RobotSimulator$Robot,
						_exercism$xelm$RobotSimulator$North,

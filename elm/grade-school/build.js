...
var _exercism$xelm$GradeSchool$allStudents = function (school) {
	return school;
};
var _exercism$xelm$GradeSchool$studentsInGrade = F2(
			...
			A2(
				...
				_elm_lang$core$List$head(
					A2(
						...
						function (_p2) {
							var _p3 = _p2;
							return _elm_lang$core$Native_Utils.eq(_p3._0, grade);
						},
						school))));
	});
var _exercism$xelm$GradeSchool$addStudent = F3(
	function (grade, name, school) {
		return _elm_lang$core$Native_Utils.eq(
			_elm_lang$core$List$length(
				A2(
					_elm_lang$core$List$filter,
					function (_p4) {
						var _p5 = _p4;
						return _elm_lang$core$Native_Utils.eq(_p5._0, grade);
					},
					school)),
			0) ? _elm_lang$core$List$sort(
			A2(
				_elm_lang$core$List_ops['::'],
				{
					ctor: '_Tuple2',
			...
			function (_p6) {
				...
				var _p9 = _p7._1;
				var _p8 = _p7._0;
				return _elm_lang$core$Native_Utils.eq(_p8, grade) ? {
					ctor: '_Tuple2',
					_0: _p8,
					_1: _elm_lang$core$List$sort(
						A2(_elm_lang$core$List_ops['::'], name, _p9))
				} : {ctor: '_Tuple2', _0: _p8, _1: _p9};
			},
			school);
	});
var _exercism$xelm$GradeSchool$empty = _elm_lang$core$Native_List.fromArray(
	[]);
		...
		[
			...
			A2(
				...
				_elm_lang$core$Native_List.fromArray(
					['Aimee']),
				A2(
					_exercism$xelm$GradeSchool$studentsInGrade,
					2,
					A3(_exercism$xelm$GradeSchool$addStudent, 2, 'Aimee', _exercism$xelm$GradeSchool$empty)))),
			A2(
			_elm_community$elm_test$ElmTest$test,
			...
			A2(
				...
				A2(
					...
					2,
					A3(
						_exercism$xelm$GradeSchool$addStudent,
						2,
						'Paul',
						A3(
							_exercism$xelm$GradeSchool$addStudent,
							2,
							'Blair',
							A3(_exercism$xelm$GradeSchool$addStudent, 2, 'James', _exercism$xelm$GradeSchool$empty)))))),
			A2(
			_elm_community$elm_test$ElmTest$test,
			...
			A2(
				...
				function () {
					var school = A3(
						...
						7,
						'Logan',
						A3(_exercism$xelm$GradeSchool$addStudent, 3, 'Chelsea', _exercism$xelm$GradeSchool$empty));
					return _elm_lang$core$Native_List.fromArray(
						[
							A2(_exercism$xelm$GradeSchool$studentsInGrade, 3, school),
							A2(_exercism$xelm$GradeSchool$studentsInGrade, 7, school)
						]);
				}())),
			A2(
			_elm_community$elm_test$ElmTest$test,
				...
				A2(
					...
					A3(
						...
						A3(
							...
							5,
							'Bradley',
							A3(_exercism$xelm$GradeSchool$addStudent, 5, 'Franklin', _exercism$xelm$GradeSchool$empty)))))),
			A2(
			_elm_community$elm_test$ElmTest$test,
			...
			A2(
				...
				_exercism$xelm$GradeSchool$allStudents(
					A3(
						_exercism$xelm$GradeSchool$addStudent,
						3,
						'Kyle',
						A3(
							...
							A3(
								...
								6,
								'Kareem',
								A3(_exercism$xelm$GradeSchool$addStudent, 4, 'Jennifer', _exercism$xelm$GradeSchool$empty))))))),
			A2(
			_elm_community$elm_test$ElmTest$test,
			...
			A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[]),
				A2(_exercism$xelm$GradeSchool$studentsInGrade, 1, _exercism$xelm$GradeSchool$empty)))
		]));

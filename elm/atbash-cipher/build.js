...
var _exercism$xelm$AtbashCipher$decode = function (str) {
	return '';
};
var _exercism$xelm$AtbashCipher$encode = function (str) {
	return '';
};
		...
		[
			...
			function (_p0) {
				...
				return A2(
					...
					'ml',
					_exercism$xelm$AtbashCipher$encode('no'));
			}),
			A2(
			_elm_community$elm_test$Test$test,
			'encode yes',
			function (_p2) {
				...
				return A2(
					_elm_community$elm_test$Expect$equal,
					'bvh',
					_exercism$xelm$AtbashCipher$encode('yes'));
			}),
			A2(
			_elm_community$elm_test$Test$test,
			'encode OMG',
			function (_p4) {
				...
				return A2(
					_elm_community$elm_test$Expect$equal,
					'lnt',
					_exercism$xelm$AtbashCipher$encode('OMG'));
			}),
			A2(
			_elm_community$elm_test$Test$test,
			'encode O M G',
			function (_p6) {
				...
				return A2(
					_elm_community$elm_test$Expect$equal,
					'lnt',
					_exercism$xelm$AtbashCipher$encode('O M G'));
			}),
			A2(
			_elm_community$elm_test$Test$test,
			'encode long word',
			function (_p8) {
				...
				return A2(
					_elm_community$elm_test$Expect$equal,
					'nrmwy oldrm tob',
					_exercism$xelm$AtbashCipher$encode('mindblowingly'));
			}),
			A2(
			_elm_community$elm_test$Test$test,
			'encode numbers',
			function (_p10) {
				...
				return A2(
					...
					_exercism$xelm$AtbashCipher$encode('Testing, 1 2 3, testing.'));
			}),
			A2(
			_elm_community$elm_test$Test$test,
			'encode sentence',
			function (_p12) {
				...
				return A2(
					_elm_community$elm_test$Expect$equal,
					'gifgs rhurx grlm',
					_exercism$xelm$AtbashCipher$encode('Truth is fiction.'));
			}),
			A2(
			_elm_community$elm_test$Test$test,
			'encode all things',
			function (_p14) {
				...
				return A2(
					...
					_exercism$xelm$AtbashCipher$encode('The quick brown fox jumps over the lazy dog.'));
			}),
			A2(
			_elm_community$elm_test$Test$test,
			'decode word',
			function (_p16) {
				...
				return A2(
					_elm_community$elm_test$Expect$equal,
					'exercism',
					_exercism$xelm$AtbashCipher$decode('vcvix rhn'));
			}),
			A2(
			_elm_community$elm_test$Test$test,
			'decode sentence',
			function (_p18) {
				...
				return A2(
					...
					_exercism$xelm$AtbashCipher$decode('zmlyh gzxov rhlug vmzhg vkkrm thglm v'));
			})
		]));
